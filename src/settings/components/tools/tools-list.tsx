...
export function ToolCardHeader({ className, ...props }: React.ComponentProps<typeof CardHeader>) {
  return <CardHeader className={cn("w-fit p-3 flex flex-row gap-2 space-y-0 items-center", className)} {...props} />;
}
...
export function ToolCardHeaderContent({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn("flex flex-col", className)} {...props} />;
}

export function ToolCardTitle({ className, children, ...props }: React.HTMLAttributes<HTMLHeadingElement>) {
  return (
...
export function ToolCardDescription({ className, children, ...props }: React.HTMLAttributes<HTMLParagraphElement>) {
  return (
...
export function ToolCardDetails({ className, children, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
...
export function ToolCardDetail({ className, children, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <p
...
export function ToolCardContent({ className, ...props }: React.ComponentProps<typeof CardContent>) {
  return (
    <CardContent
...
export function ToolCardTransitionState({
  className,
  state,
  ...props
